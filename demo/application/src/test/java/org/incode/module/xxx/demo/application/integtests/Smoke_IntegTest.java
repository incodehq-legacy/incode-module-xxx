 ...
 *  under the License.
 */
package org.incode.module.xxx.demo.application.integtests;
...
public class Smoke_IntegTest extends DemoAppIntegTestAbstract {
    ...
    public void create() throws Exception {
        ...
        // when
        List<XxxObject> all = wrap(menu).listAll();
        ...
        // when
        final XxxObject fred = wrap(menu).create("Fred");
        ...
        // when
        final XxxObject bill = wrap(menu).create("Bill");
        transactionService.flushTransaction();
